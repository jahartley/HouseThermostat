...
class hvacLogic {
    ...
    tempLogicWorker(temp) {
        ...
        //console.log("tempLogic Worker temp, cOff, hOff, cOn, hOn", temp, "\t", coolOff, "\t", heatOff, "\t", coolOn, "\t", heatOn, "\t", this.tempmode, "\t", this.mode, (coolOff < 0 ? 'coolOff' : ''), (heatOff < 0 ? 'heatOff' : ''), (coolOn < 0 ? 'coolOn' : ''), (heatOn < 0 ? 'heatOn' : ''));
